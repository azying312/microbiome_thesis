...
## Load Data
merged_diet_data <- read_csv("/Volumes/T7/microbiome_data/cleaned_data/diet_intermediary/manual_merged_diet_data.csv")
...
write.csv(randomized_check_dupes,
          file = "/Volumes/T7/microbiome_data/cleaned_data/diet_intermediary/check_dupes_diet_data.csv",
          row.names = FALSE)
...
write.csv(not_in_dupes,
          file = "/Volumes/T7/microbiome_data/cleaned_data/diet_intermediary/no_dupes_diet_data.csv",
          row.names = FALSE)
...
write.csv(no_nutrition_info,
          file = "/Volumes/T7/microbiome_data/cleaned_data/diet_intermediary/no_nutrition.csv",
          row.names = FALSE)
...
write.csv(type_other,
          file = "/Volumes/T7/microbiome_data/cleaned_data/diet_intermediary/type_other_diet_data.csv",
          row.names = FALSE)
