...
dim(bacteria_taxa_df) # 3830 10 -> 92499

length(bacteria_taxa_df$Species) # 3830 -> 92499
# number of missing Species/Species_exact
sum(bacteria_taxa_df$Species=="") # 1871 -> 40397
...
sum(bacteria_taxa_df$Species_exact=="") # 1716 missing -> 39845
sum(bacteria_taxa_df$Species_exact!="") # 2114 not missing -> 52654
...
bacteria_taxa_df <- as.data.frame(bacteria_taxa_table)
dim(bacteria_taxa_df) # 668 OTU -> 2015
